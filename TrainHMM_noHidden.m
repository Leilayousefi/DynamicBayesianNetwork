function [bnet2 LLtrace traindata] = TrainHMM(train, order, class, k, intra1, inter1)
...
%     intra(1,1) =1;
    bnet = mk_dbn(intra1, inter1, ns, 'discrete', ds, 'observed', obs);%'eclass1', eclass1, 'eclass2', eclass2, 
% 
